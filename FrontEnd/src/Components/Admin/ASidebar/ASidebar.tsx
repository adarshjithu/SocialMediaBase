...
function ASidebar({ children }: any) {
     ...
     return (
          <div>
               ...
               >
                    <div className="h-full px-3 py-4 overflow-y-auto bg-white-50 dark:bg-gray-800" style={{ borderRight: ".5px solid #dddddd" }}>
                         <ul className={`space-y-2 font-medium ${isSidebarOpen ? "block" : ""}`}>
                              ...
                              <li>
                                   <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-[#7c007c] hover:text-white group">
                                        <i className="fa-regular fa-bell fa-solid fa-lg icon"></i>
                                        <span className="flex-1 ms-3 whitespace-nowrap">Notification</span>
                                   </a>
                              </li>
                              <li>
                                   <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-[#7c007c] hover:text-white group">
                                        <i className="fa-regular fa-pen-nib fa-solid fa-lg icon"></i>
                                        <span className="flex-1 ms-3 whitespace-nowrap">Themes</span>
                                   </a>
                              </li>
                              <li>
                                   <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-[#7c007c] hover:text-white group">
                                        <i className="fa-regular fa-lock fa-solid fa-lg icon"></i>
                              ...
                              <li>
                                   <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-[#7c007c] hover:text-white group">
                                        <i className="fa-regular fa-bars fa-solid fa-lg icon"></i>
               ...
               <div onClick={() => setIsSidebarOpen(!isSidebarOpen)} className="sm:ml-64 h-[100vh] bg-[#dedfe0] ">
                    <Header />
                    {children}
               </div>
          </div>
