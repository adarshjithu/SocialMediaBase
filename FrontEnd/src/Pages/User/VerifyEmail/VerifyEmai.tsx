...
import { verifyEmail, verifyUser } from "../../../Services/apiService/userService";
               ...
               <div className="bg-white h-[70vh]  md:h-[500px] sm:h-[500px]   w-[768px] rounded-[20px] flex m-4 shadow-[2px_2px_15px_grey] ">
                    <div className="left h-[100%] flex items-center flex-col justify-center shadow-xl">
                         ...
                         <form action="" className="flex flex-col">
                              <div className="p-8 ">
                                   <TextField value={formData} onChange={(e)=>setFormData(e.target.value)} size="small" label="  Email Or Phonenumber" className="w-[100%]" type="te" />
